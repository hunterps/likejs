function likelink(a, c, b) {
    ...
    document.getElementById(b + "likeimage" + a) && (document.getElementById(b + "likeimage" + a).setAttribute("src", "https://hunterps.github.io/likebutton/like%20(1).png"), document.getElementById(b + "like" + a).style.backgroundImage = "none");
    ...
    document.getElementById("likeimage" + a) && (document.getElementById("likeimage" + a).setAttribute("src", "https://hunterps.github.io/likebutton/like.png"), document.getElementById("like" + a).style.backgroundImage = "none");
